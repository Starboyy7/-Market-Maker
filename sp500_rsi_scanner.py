...
RSI_1H_LONG_MIN  = 60   # LONG válido: RSI 1H > 60 (alcista claro, sin techo — uptrends fuertes ok)
RSI_1H_SHORT_MAX = 40   # SHORT válido: RSI 1H < 40 (bajista claro)
RSI_1H_SHORT_MIN = 32   # SHORT bloqueado: RSI 1H < 32 (oversold extremo — caso ADBE 31.9)
...
def calc_alignment(ticker: str, tf_data: dict) -> Text:
    ...
    bias = ("long"  if rsi_1h_pre > RSI_1H_LONG_MIN else
